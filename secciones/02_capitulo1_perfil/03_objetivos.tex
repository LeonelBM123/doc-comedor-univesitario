...
\begin{itemize}
    \item Capturar y determinar los requisitos funcionales y no funcionales del proceso de gestión del comedor universitario mediante entrevistas, revisión del flujo de postulación masiva (más de 20,000 carpetas), normativas de auditoría física (firmas y carnet) y los flujos operativos de la DUBSS - UAGRM.
