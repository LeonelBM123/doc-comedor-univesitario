...
Desarrollar un Sistema de Información Web y Móvil para la Gestión Integral del Comedor Universitario de la UAGRM con Reportes de Business Intelligence (BI) y modelos de Machine Learning Predictivo para la DUBS - UAGRM, que permita automatizar la postulación en línea, precalificar algorítmicamente la vulnerabilidad socioeconómica de los estudiantes, gestionar la asistencia física/digital y proveer dashboards analíticos y proyecciones predictivas que apoyen la toma de decisiones institucionales y auditorías.
